...
named_entities_file="/Users/dariastetsenko/Desktop/shakespear_sentiment.txt"

# Directory containing chapter files
chapter_dir="/Users/dariastetsenko/Desktop/Shakespeare/chapters"
...
for chapter_file in "$chapter_dir"/chapter_*.txt; do
    ...
    grep -i -w -f "$named_entities_file" "$chapter_file" > "Chapter${chapter_number}_Sentiments.txt"
done